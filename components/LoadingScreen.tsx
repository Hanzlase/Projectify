  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-[#18181B] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#1a5d1a]/5 dark:bg-[#1a5d1a]/10 rounded-full" />
      </div>
      ...
      <div className="relative flex flex-col items-center gap-6 animate-fadeIn">
        ...
        <div className="flex gap-1.5">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="w-2 h-2 bg-[#1a5d1a] dark:bg-[#4ade80] rounded-full animate-bounce"
