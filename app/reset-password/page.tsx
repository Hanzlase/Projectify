...
function ResetPasswordContent() {
  ...
  if (isValidating) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-green-50/30 p-4">
        <motion.div
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">Validating Reset Link</h2>
            ...
            <div className="p-8 text-center">
              ...
              <div className="space-y-3">
                ...
                <Link href="/login" className="block">
                  <button className="w-full h-12 bg-white border border-slate-200 text-slate-700 font-semibold rounded-xl hover:border-slate-300 transition-all duration-300">
                    Return to Login
                  </button>
                </Link>
              </div>
                ...
                <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50/50 border border-green-100 rounded-xl mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left text-sm">
                      <p className="font-semibold mb-1 text-slate-900">Account Secured</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
            ...
            <div className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-600">
                  Hi <span className="font-semibold text-slate-800">{userName}</span>, create a new secure password for your account
                </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      disabled={isLoading}
                      className="w-full h-12 pl-12 pr-12 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1E6F3E]/20 focus:border-[#1E6F3E] transition-all duration-200 disabled:opacity-50"
                    />
                    <button
                      type="button"
