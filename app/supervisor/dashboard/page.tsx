...
export default function SupervisorDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gray-900 flex">
      ...
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 left-0 right-0 h-14 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 z-20 flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-[#1a5d1a] rounded-lg flex items-center justify-center">
            <GraduationCap className="w-4 h-4 text-white" />
          </div>
          <span className="font-bold text-gray-900 dark:text-white">Projectify</span>
        </div>
        <div className="flex items-center gap-2">
          <NotificationBell />
          <div 
      ...
      <div className="flex-1 md:ml-56 mt-14 md:mt-0">
        {/* Desktop Header */}
        <header className="hidden md:block bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm sticky top-0 z-10 px-4 md:px-6 py-3 border-b border-gray-100 dark:border-gray-700">
            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border-0 rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#1a5d1a]/20 transition-all"
                />
              </div>
            </div>
        ...
        <main className="p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all" onClick={() => router.push('/supervisor/students')}>
                <CardContent className="p-5">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Students</p>
                      <p className="text-4xl font-bold text-gray-900 dark:text-white">{stats.totalStudents}</p>
                    </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all" onClick={() => router.push('/supervisor/invitations?filter=pending')}>
                <CardContent className="p-5">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Pending</p>
                      <p className="text-4xl font-bold text-gray-900 dark:text-white">{stats.pendingProposals}</p>
                    </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all" onClick={() => router.push('/supervisor/groups')}>
                <CardContent className="p-5">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Approved</p>
                      <p className="text-4xl font-bold text-gray-900 dark:text-white">{stats.approvedProposals}</p>
                    </div>
                    <div className="p-1.5 bg-green-100 dark:bg-green-900/30 rounded-lg">
                      <CheckCircle2 className="w-4 h-4 text-green-600 dark:text-green-400" />
                    </div>
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-3">This semester</p>
                </CardContent>
              </Card>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-white">Project Status</h3>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-gray-900 dark:text-white">Group Invitations</h4>
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{pendingInvitations.length} pending requests</p>
                        </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">Chat with your groups</p>
                        </div>
                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#1a5d1a] group-hover:translate-x-1 transition-all flex-shrink-0" />
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">Browse & manage projects</p>
                        </div>
                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#1a5d1a] group-hover:translate-x-1 transition-all flex-shrink-0" />
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">View & edit profile</p>
                        </div>
                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#1a5d1a] group-hover:translate-x-1 transition-all flex-shrink-0" />
                      </div>
                    </motion.div>
              ...
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl h-full">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-5">
                    <h3 className="font-semibold text-gray-900 dark:text-white text-lg">Invitations</h3>
                    <div className="flex items-center gap-2">
                      ...
                      {pendingInvitations.slice(0, 3).map((invitation, index) => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-1">
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">{invitation.groupName}</p>
                            <span className="text-xs px-2 py-0.5 rounded-full bg-amber-200 dark:bg-amber-800 text-amber-800 dark:text-amber-300">
                              Pending
                            </span>
                          </div>
                          <p className="text-xs text-gray-600 dark:text-gray-400 truncate">{invitation.projectTitle}</p>
                          <div className="flex items-center gap-1 mt-1.5">
                            <Users className="w-3 h-3 text-gray-400" />
                            <span className="text-xs text-gray-500 dark:text-gray-400">{invitation.studentCount} students</span>
                          </div>
                        </motion.div>
                      ))}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="font-semibold text-gray-900 dark:text-white text-lg">My Groups</h3>
                    </div>
                    <span className="text-xs text-gray-500 dark:text-gray-400">{groups.length} groups</span>
                  </div>
                  {groups.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {groups.slice(0, 4).map((group, index) => (
                        <motion.div 
                          ...
                          animate={{ opacity: 1, x: 0 }} 
                          transition={{ delay: 0.4 + index * 0.05 }} 
                          className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all group/card"
                        >
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">{group.studentCount} students</p>
                              </div>
                            </div>
                          ...
                          {group.projectTitle && (
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-3 truncate flex items-center gap-1.5">
                            ...
                            <div className="flex items-center gap-1">
                              <div className="flex -space-x-2">
                                {group.students.slice(0, 3).map((student, idx) => (
                                  <div key={idx} className="w-6 h-6 rounded-full bg-[#1a5d1a] text-white text-[10px] flex items-center justify-center border-2 border-white dark:border-gray-700 overflow-hidden">
                                ...
                                {group.students.length > 3 && (
                                  <div className="w-6 h-6 rounded-full bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-300 text-[10px] flex items-center justify-center border-2 border-white dark:border-gray-700">
                                    +{group.students.length - 3}
                                  </div>
                                )}
                              </div>
                    ...
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Accept invitations to start supervising groups</p>
                    </div>
                  )}
                  {groups.length > 4 && (
                    <div className="pt-4 border-t border-gray-100 dark:border-gray-700 mt-4 flex items-center justify-between">
                      <p className="text-xs text-gray-500 dark:text-gray-400">+{groups.length - 4} more groups</p>
                      <button 
                    ...
                    <div className="space-y-3">
                      {recentActivity.map((activity, index) => (
                        <motion.div 
                          ...
                          className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all"
                        >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-5">
                    <h3 className="font-semibold text-gray-900 dark:text-white text-lg">Your Info</h3>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gradient-to-r from-[#1a5d1a]/5 to-[#1a5d1a]/10 dark:from-[#1a5d1a]/10 dark:to-[#1a5d1a]/20 rounded-xl border border-[#1a5d1a]/20">
                      ...
                      <p className="text-lg font-semibold text-gray-900 dark:text-white">FYP Supervisor</p>
                    </div>
                    ...
                    {dashboardData?.specialization && (
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{dashboardData.specialization}</p>
                      </div>
                    )}
                      ...
                      <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-900 dark:text-white">{dashboardData.campusName}</p>
                          </div>
                        </div>
                      </div>
                    )}
          ...
          {groups.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
              <Card className="border-0 shadow-sm bg-white dark:bg-gray-800 rounded-2xl">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-5">
                    <h3 className="font-semibold text-gray-900 dark:text-white text-lg">Students Under Supervision</h3>
                    <GraduationCap className="w-5 h-5 text-[#1a5d1a]" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {groups.map((group) => (
                      <div key={group.id} className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">{group.name}</p>
                            {group.projectTitle && (
                              <p className="text-xs text-gray-500 dark:text-gray-400 truncate max-w-[150px]">{group.projectTitle}</p>
                            )}
                          </div>
                        </div>
                        <div className="space-y-2">
                          {group.students.slice(0, 3).map((student, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-xs">
                              ...
                              <span className="text-gray-400 dark:text-gray-500">({student.rollNumber})</span>
                            </div>
                          ))}
                          {group.students.length > 3 && (
                            <p className="text-xs text-gray-400 dark:text-gray-500">+{group.students.length - 3} more</p>
                          )}
                        </div>
                      </div>
                    ))}
