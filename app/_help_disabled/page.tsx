      ...
      >
        ...
        <nav className="flex-1 px-3">
          ...
          <div className="space-y-1">
            <div className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm bg-[#1a5d1a] text-white font-medium">
          ...
          <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-3 px-3 mt-8">
            Resources
          </p>
          <div className="space-y-1">
            <a
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-[#d1e7d1] rounded-xl">
                <Phone className="w-4 h-4 text-[#1a5d1a]" />
                <span className="text-sm font-medium text-[#1a5d1a]">
