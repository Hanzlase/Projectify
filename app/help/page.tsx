        ...
        >
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-zinc-400">Get help with your account and login issues</p>
            </div>
          </div>
        </motion.header>
        ...
        <div className="p-4 sm:p-6 lg:p-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            >
              ...
              <div
                id="student-login"
                className="bg-white dark:bg-[#27272A] rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-700 hover:shadow-md transition-shadow"
              >
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-gray-50 dark:bg-zinc-700 rounded-lg px-3 py-2">
            ...
            >
              <div className="bg-white dark:bg-[#27272A] rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-700 overflow-hidden h-full">
                {/* Form Header */}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Input
                              ...
                              className="h-12 pl-11 rounded-xl bg-gray-50 dark:bg-zinc-700 border-gray-200 dark:border-zinc-600 focus:border-[#1a5d1a] focus:ring-[#1a5d1a]/20 dark:text-[#E4E4E7] dark:placeholder-zinc-400"
                              required
                            />
                          </div>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            className="h-12 pl-11 rounded-xl bg-gray-50 dark:bg-zinc-700 border-gray-200 dark:border-zinc-600 uppercase focus:border-[#1a5d1a] focus:ring-[#1a5d1a]/20 dark:text-[#E4E4E7] dark:placeholder-zinc-400"
                          />
                        </div>
                      </div>
                            ...
                            <button
                              ...
                              className={`relative flex flex-col items-center gap-2 p-4 rounded-xl border-2 text-sm font-medium transition-all ${
                                issueType === type.value
                                  ...
                                  : "border-gray-200 dark:border-zinc-600 bg-gray-50 dark:bg-zinc-700 text-gray-600 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-600 hover:border-gray-300 dark:hover:border-gray-500"
                              }`}
                            >
                              {issueType === type.value && (
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          rows={5}
                          required
                          className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 text-gray-800 dark:text-[#E4E4E7] placeholder:text-gray-400 focus:border-[#1a5d1a] focus:ring-2 focus:ring-[#1a5d1a]/20 focus:outline-none resize-none text-sm"
                        />
                      </div>
