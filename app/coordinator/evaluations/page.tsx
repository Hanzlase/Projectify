      ...
      <div className="flex-1 md:ml-56 mt-14 md:mt-0">
        ...
        <header className="bg-white dark:bg-gray-800 sticky top-0 z-10 px-4 md:px-6 py-5 border-b border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 max-w-7xl mx-auto">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Evaluation Management</h1>
        ...
        <main className="p-4 md:p-6 max-w-7xl mx-auto">
          ...
          {/* Control Bar */}
          <Card className="border-0 shadow-sm rounded-2xl dark:bg-gray-800 mb-6">
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-12 h-11 rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-700"
                  />
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="h-11 pl-4 pr-10 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white text-sm font-medium appearance-none bg-white cursor-pointer min-w-[140px]"
                    >
            ...
            {filteredEvaluations.length === 0 ? (
              <Card className="border-0 shadow-sm rounded-2xl dark:bg-gray-800">
                <CardContent className="p-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Evaluations Found</h3>
              ...
              filteredEvaluations.map((evaluation, index) => (
                ...
                >
                  <Card className="border-0 shadow-sm rounded-2xl dark:bg-gray-800 overflow-hidden hover:shadow-lg transition-all">
                    <CardContent className="p-0">
                      ...
                      <div className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          {/* Due Date */}
                          <div className="hidden md:flex flex-col items-center px-4 border-l border-r border-gray-100 dark:border-gray-700">
                          ...
                          {/* Marks */}
                          <div className="hidden md:flex flex-col items-center px-4 border-r border-gray-100 dark:border-gray-700">
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="w-10 h-10 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center justify-center transition-all"
                            >
                            ...
                            <AnimatePresence>
                              {showActionsMenu === evaluation.id && (
                                <motion.div
                                  ...
                                  className="absolute right-0 top-12 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 py-2 min-w-[160px] z-20"
                                >
                                  <button
                                    onClick={() => {
                      ...
                      <AnimatePresence>
                        {expandedEvaluations.has(evaluation.id) && (
                          ...
                          >
                            <div className="px-5 pb-5 pt-2 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700">
          ...
          >
            ...
            >
              <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between bg-gradient-to-r from-[#1E6F3E]/5 to-transparent">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Create New Evaluation</h2>
              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white resize-none"
                  />
                </div>
      ...
      <AnimatePresence>
        {showGradeModal && selectedSubmission && selectedEvaluation && (
          ...
          >
            ...
            >
              <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-[#1E6F3E]/5 to-transparent">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Grade Submission</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                  <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Submitted Content:</p>
              ...
              <div className="p-6 overflow-y-auto flex-1 space-y-5">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl text-center">
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{selectedEvaluation.submissionsCount}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Submissions</p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl text-center">
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{selectedEvaluation.gradedCount}</p>
