        ...
        <main className="p-4 md:p-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-[#E4E4E7]">Add Supervisors</h1>
              ...
              <Button
                ...
                className={`w-full h-10 md:h-11 text-sm md:text-base shadow-sm transition-all duration-300 rounded-xl ${
                  mode === 'single' 
                    ...
                    : 'bg-white dark:bg-[#27272A] hover:bg-gray-50 dark:hover:bg-zinc-700 dark:text-zinc-300'
                }`}
              >
                Single Entry
              </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                {mode === 'single' ? (
                  <form onSubmit={handleSingleSubmit} className="space-y-5">
                    <div className="space-y-2">
                      <Label htmlFor="name" className="text-sm font-medium text-gray-700 dark:text-zinc-300">Supervisor Name *</Label>
                      <div className="relative">
                  ...
                  <form onSubmit={handleBulkSubmit} className="space-y-5">
                    <div className="space-y-2">
                      <Label htmlFor="csvFile" className="text-sm font-medium text-gray-700 dark:text-zinc-300">Upload CSV File</Label>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="supervisorsData" className="text-sm font-medium text-gray-700 dark:text-zinc-300">Enter Supervisor Data (One per line)</Label>
                      <textarea
                        id="supervisorsData"
            ...
            <Card className="lg:col-span-1 bg-white dark:bg-[#27272A] shadow-sm border-0 rounded-2xl overflow-hidden h-fit lg:sticky lg:top-6">
              <CardHeader className="border-b border-gray-100 dark:border-zinc-700 bg-white dark:bg-[#27272A] pb-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold text-gray-900 dark:text-[#E4E4E7]">Results</CardTitle>
                  </div>
                </div>
                <CardDescription className="text-sm text-gray-600 dark:text-zinc-400">Operation status and details</CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                {!results ? (
                  <div className="text-center py-12 text-gray-500 dark:text-zinc-400">
                    <svg className="w-16 h-16 mx-auto mb-4 text-gray-300 dark:text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
