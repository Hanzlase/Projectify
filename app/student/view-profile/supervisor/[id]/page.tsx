            ...
            >
              <Card className="border-0 shadow-xl bg-white dark:bg-[#27272A] overflow-hidden">
                ...
                <CardContent className="pt-0 pb-6 px-6">
                  ...
                  {profile.specialization && (
                    <div className="bg-gradient-to-r from-[#f5f5f7] to-[#e8f5e8]/50 dark:from-gray-700 dark:to-[#1a5d1a]/20 rounded-xl p-3 mb-4 border border-slate-100 dark:border-zinc-600">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0">
                          <p className="text-xs text-slate-500 dark:text-zinc-400">Specialization</p>
                          <p className="text-sm font-semibold text-slate-800 dark:text-[#E4E4E7] truncate">{profile.specialization}</p>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              <Card className="border-0 shadow-lg bg-white dark:bg-[#27272A] mt-4">
                <CardContent className="p-5">
                  <h3 className="text-sm font-semibold text-slate-500 dark:text-zinc-400 uppercase tracking-wider mb-4">Contact & Info</h3>
            ...
            <Card className="border-0 shadow-xl bg-white dark:bg-[#27272A] overflow-hidden">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center gap-2 mb-5">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 dark:text-[#E4E4E7]">Availability & Capacity</h3>
                    <p className="text-sm text-slate-500 dark:text-zinc-400">Current supervision workload</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
                  ...
                  {/* Max Capacity */}
                  <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-700 dark:to-gray-600 rounded-xl p-4 border border-slate-200 dark:border-zinc-600">
                    <div className="flex items-center justify-between mb-2">
                      <Target className="w-6 h-6 text-slate-600 dark:text-zinc-400" />
                      <span className="text-2xl font-bold text-slate-700 dark:text-[#E4E4E7]">{maxGroups}</span>
                    </div>
                    <p className="text-sm text-slate-600 dark:text-zinc-400 font-medium">Max Capacity</p>
                  </div>
                ...
                <div className="bg-slate-50 dark:bg-zinc-700 rounded-xl p-4 border border-slate-100 dark:border-zinc-600">
                  ...
                  <div className="h-4 bg-slate-200 dark:bg-zinc-600 rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
              ...
              <Card className="border-0 shadow-lg bg-white dark:bg-[#27272A]">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 dark:text-[#E4E4E7]">Research Domains</h3>
                  </div>
            ...
            {profile.description && (
              <Card className="border-0 shadow-lg bg-white dark:bg-[#27272A]">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="text-slate-600 dark:text-zinc-300 leading-relaxed whitespace-pre-wrap">{profile.description}</p>
                </CardContent>
              </Card>
            )}
              ...
              <Card className="border-0 shadow-lg bg-white dark:bg-[#27272A]">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 dark:text-[#E4E4E7]">Technical Skills & Expertise</h3>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {profile.skills.split(',').map((skill, i) => (
                      <span 
                        key={i} 
                        className="px-4 py-2 bg-gradient-to-r from-[#f5f5f7] to-[#e8f5e8] dark:from-gray-700 dark:to-[#1a5d1a]/20 text-[#1a5d1a] dark:text-[#4ade80] rounded-xl text-sm font-medium border border-[#1a5d1a]/10 dark:border-zinc-600"
                      >
                        {skill.trim()}
                      </span>
                    ))}
              ...
              <Card className="border-0 shadow-lg bg-white dark:bg-[#27272A] overflow-hidden">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-slate-900 dark:text-[#E4E4E7]">Achievements & Recognition</h3>
                  </div>
