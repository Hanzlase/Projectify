  ...
  try {
    ...
    const project = await (prisma as any).project.create({
      data: {
        ...
        thumbnailUrl: thumbnailUrl ? thumbnailUrl.substring(0, 500) : null,
        documentUrl: documentUrl ? documentUrl.substring(0, 500) : null,
        documentName: documentName ? documentName.substring(0, 255) : null,
        repositoryUrl: repositoryUrl ? repositoryUrl.substring(0, 500) : null,
        demoUrl: demoUrl ? demoUrl.substring(0, 500) : null,
        createdById: userId,
        groupId,
        campusId,
